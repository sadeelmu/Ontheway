...
class MockService {
  List<LocationModel> savedmockLoction = [
    LocationModel(
        isFavrite: false, locationName: "Work", locationSubTitle: "Abdali"),
    LocationModel(
        isFavrite: false,
        locationName: "University",
        locationSubTitle: "Queen Rania Street"),
    LocationModel(
        isFavrite: true, locationName: "Home", locationSubTitle: "Khelda"),
  ];
  List<LocationModel> recentmockLoction = [
    LocationModel(
        isFavrite: true,
        locationName: "Beyond Limits",
        locationSubTitle: "Abdali"),
    LocationModel(
        isFavrite: false,
        locationName: "PSUT",
        locationSubTitle: "Queen Rania Street"),
